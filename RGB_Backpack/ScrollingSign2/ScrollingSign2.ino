 ...
 * Version: 1.0
 *
 * This is variant 2, which displays the 5x7 letters top-adjusted vertically in
 * the 8x8 matrix, allowing letters with descenders to go below the baseline by
 * 1 pixel.
 */
...
char message[] = "Welcome to Los Gatos! Today's feature is \"X-Men\"  ";
